...
const markers = [
  ...
  { markerOffset: 25, name: "Utrecht", link: null, hasPost: false, coordinates: [5.12142, 52.090737] },
  { markerOffset: 25, name: "Bermuda", link: null, hasPost: false, coordinates: [-64.7505, 32.3078] },
  { markerOffset: 25, name: "Canggu", link: "/tag/bali/", hasPost: true, coordinates: [115.1385192, -8.6478175] },
  { markerOffset: 25, name: "Singapore", link: null, hasPost: false, coordinates: [103.819836, 1.352083] },
  { markerOffset: 25, name: "Chiang Mai", link: null, hasPost: false, coordinates: [98.9817163, 18.7060641] },
  ...
  { markerOffset: 25, name: "Prague", link: null, hasPost: false, coordinates: [14.4378005, 50.0755381] },
  { markerOffset: 25, name: "Dublin", link: null, hasPost: false, coordinates: [-6.2603097, 53.3498053] },
  ...
  { markerOffset: 25, name: "Lisbon", link: null, hasPost: false, coordinates: [-9.1393, 38.7223] },
]
    ...
    return (
      <div style={wrapperStyles}>
        ...
        >
          ...
          {markers.map(({ name, hasPost, link, coordinates, markerOffset }) => (
            <Marker
              key={name}
